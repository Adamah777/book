## cast tempo zone deposit

Encrypt a deposit and submit it to a portal on Tempo L1.

--rpc-url selects the L1 RPC. The receipt confirms L1 submission, not zone
completion.

:::terminal

```bash
$ cast tempo zone deposit --help
```

```txt
Usage: cast tempo zone deposit [OPTIONS] --portal <PORTAL> --amount <AMOUNT>
...
Options:
      ...
      --refund-recipient <REFUND_RECIPIENT>
          Tempo L1 refund recipient if the deposit fails. Defaults to the
          signing wallet
