...
```bash
$ cast safe propose --help
```

```txt
Usage: cast safe propose [OPTIONS] <SAFE> <TO> [SIG] [ARGS]...
...
Options:
      --data <DATA>
          Raw calldata. Cannot be combined with a function signature or
          arguments
      ...
      --operation <OPERATION>
          ...
          [default: call]
          [possible values: call, delegate-call]

      --safe-tx-gas <SAFE_TX_GAS>
